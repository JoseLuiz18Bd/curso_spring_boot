...
public class WebConfig implements WebMvcConfigurer{
	...
	@Value("${cors.originsPatterns:default}") // permitir cors de forma global
	...
	@Override  // permitir cors de forma global
	public void addCorsMappings(CorsRegistry registry) {
		var allowedOrigins = corsOriginsPatterns.split(",");
		registry.addMapping("/**") // registrando todas as rotas da aplicação
			.allowedMethods("*") // verbos permitidos
