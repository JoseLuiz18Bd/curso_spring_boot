...
import br.com.curso_spring.intregationtests.vo.PersonVO;
//import br.com.curso_spring.integrationtests.vo.PersonVO;
...
public class PersonControllerJsonTest extends AbstractIntegrationTest {
	...
	public void testCreate() throws JsonMappingException, JsonProcessingException {
		...
		assertEquals("José Luiz", createPerson.getFirstName());
		assertEquals("Santos", createPerson.getLastName());
		assertEquals("Uberlândia Minas Gerais Brasil", createPerson.getAddress());
	...
	public void testCreateWithWrongOrigin() throws JsonMappingException, JsonProcessingException {
		...
		specification = new RequestSpecBuilder()
				.addHeader(TestConfigs.HEADER_PARAM_ORIGIN, "https://github.com/JoseLuiz18Bd/curso_spring_boot")
				.setBasePath("/api/person/v1")
				.setPort(TestConfigs.SERVER_PORT)
					.addFilter(new RequestLoggingFilter(LogDetail.ALL))
					.addFilter(new ResponseLoggingFilter(LogDetail.ALL))
	...
	public void testFindById() throws JsonMappingException, JsonProcessingException {
		...
		assertEquals("José Luiz", persistedPerson.getFirstName());
		assertEquals("Santos", persistedPerson.getLastName());
		assertEquals("Uberlândia Minas Gerais Brasil", persistedPerson.getAddress());
